  ...
  <body data-home-page="{{ route('home') }}" data-home-page-title="Acceuil" class="u-body u-stick-footer u-xl-mode" data-lang="fr"><header class=" u-clearfix u-header u-section-row-container" id="sec-6b2a" style=""><div class="u-section-rows">
        ...
        <div class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-clearfix u-section-row u-sticky u-sticky-0620 u-white u-section-row-2" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="" id="sec-b198">
          ...
          <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-xl u-sheet-2">
            ...
            <h5 class="u-text u-text-1">Centre National de Référence de la Drépanocytose Antoinette SASSOU NGUESSO</h5>
          </div>
...
borders: top right bottom left !important
            ...
            <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1" data-responsive-from="SM">
              ...
              <div class="u-custom-menu u-nav-container">
                <ul class="u-nav u-spacing-30 u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-border-2 u-border-active-grey-90 u-border-hover-grey-50 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90" href="{{ route('home') }}" style="padding: 10px 0px;">Acceuil</a>
                    </li><li class="u-nav-item"><a class="u-border-2 u-border-active-grey-90 u-border-hover-grey-50 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90" href="{{ route('about') }}" style="padding: 10px 0px;">À propos</a>
                    ...
                    </li><li class="u-nav-item"><a class="u-border-2 u-border-active-grey-90 u-border-hover-grey-50 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90" href="#" style="padding: 10px 0px;">Réalisations</a>
                    </li>
                </ul>
              </div>
                ...
                <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                  <div class="u-inner-container-layout u-sidenav-overflow">
                    ...
                    <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ route('home') }}">Acceuil</a>
                        </li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ route('about') }}">À propos</a>
                        </li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ route('contact') }}">Nous contacter</a>
                        </li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Réalisations</a>
                        </li>
                    </ul>
                  </div>
                </div>
    ...
    <footer class="u-clearfix u-footer u-white" id="sec-b583"><div class="u-clearfix u-sheet u-sheet-1">
            ...
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ route('contact') }}">Contactez-nous</a>
                    </li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Cookie & Confidentialité</a>
                    </li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="https://www.sante.gouv.cg" target="_blank">Ministère de la santé</a>
                    </li></ul>
              </div>
            </div>
            <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
        ...
        <p class="u-text u-text-1"> Le
            ...
            et un établissement public spécialisé dont la mission principale est celle
            d’assurer des soins préventifs, curatifs et réadaptationnels en faveur de la
            drépanocytose ainsi que d’autres maladies génétiques du sang.
        </p>
        <div class="u-border-2 u-border-grey-15 u-expanded-width u-line u-line-horizontal u-line-1"></div>
        <p class="u-text u-text-2"><span class="u-file-icon u-icon"><img src="{{ asset('images/2088619.png')}}" alt=""></span>&nbsp;<span style="font-weight: 700; font-size: 0.875rem;">2022-2023 Tous droits réservés |Centre National de Référence de la Drépanocytose</span>
        </p>
        <p class="u-text u-text-default-lg u-text-default-md u-text-default-xl u-text-3">Développé par <a href="https://visibility242.com" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-custom-color-3 u-btn-1">Visiblity242</a>
        </p>
